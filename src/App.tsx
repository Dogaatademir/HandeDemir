  ...
  return (
    <>
          ...
          <div className="about">
            ...
            <div className="about__content" data-aos="fade-left">
              ...
              <a href="#services" className="link">
                Hizmetlerimi keşfedin <i data-feather="arrow-right" />
              </a>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="section" data-aos="fade-up">
        <div className="container">
          <div className="section__head">
            <h2 className="section__title">İletişime Geçin</h2>
            <div className="section-divider" />
            <p className="section__lead">
              Hizmetlerim hakkında sorularınız mı var veya daha fazla bilgi edinmek mi istiyorsunuz? Sizden haber almaktan memnuniyet duyarım.
            </p>
          </div>

          <div className="contact">
            <div className="contact__info" data-aos="fade-right">
              <h3 className="contact__title">İletişim Bilgileri</h3>
              <div className="info">
                <div className="info__row">
                  <div className="info__icon"><i data-feather="mail" /></div>
                  <div><h4>E-posta</h4><p className="muted">hello@serenepath.com</p></div>
                </div>
                <div className="info__row">
                  <div className="info__icon"><i data-feather="phone" /></div>
                  <div><h4>Telefon</h4><p className="muted">(555) 123-4567</p></div>
                </div>
                <div className="info__row">
                  <div className="info__icon"><i data-feather="map-pin" /></div>
                  <div>
                    <h4>Konum</h4>
                    <p className="muted">Dünya çapında çevrimiçi seanslar mevcuttur</p>
                    <p className="muted">Portland, Oregon merkezli</p>
                  </div>
                </div>
              </div>

              <h4 className="follow__title">Beni Takip Edin</h4>
              <div className="socials">
                <a href="#" className="social"><i data-feather="facebook" /></a>
                <a href="#" className="social"><i data-feather="instagram" /></a>
                <a href="#" className="social"><i data-feather="twitter" /></a>
                <a href="#" className="social"><i data-feather="youtube" /></a>
              </div>
            </div>

            <div className="contact__form" data-aos="fade-left">
              <h3 className="form__title">Mesaj Gönder</h3>
              <form>
                <label className="field"><span>Adınız</span><input type="text" /></label>
                <label className="field"><span>E-posta</span><input type="email" /></label>
                <label className="field"><span>Konu</span><input type="text" /></label>
                <label className="field"><span>Mesaj</span><textarea rows={4} /></label>
                <button type="submit" className="btn btn--primary btn--block btn--lg">Mesajı Gönder</button>
              </form>
            </div>
          </div>
        </div>
